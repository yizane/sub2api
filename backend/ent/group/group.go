...
const (
	...
	// FieldTierFallbackGroupID holds the string denoting the tier_fallback_group_id field in the database.
	FieldTierFallbackGroupID = "tier_fallback_group_id"
...
// ByTierFallbackGroupID orders the results by the tier_fallback_group_id field.
func ByTierFallbackGroupID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTierFallbackGroupID, opts...).ToFunc()
}
